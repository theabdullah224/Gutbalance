...
function Sec1() {
  return (
    <div>
      ...
      description="The Mediterranean and Centenarian diets are renowned for their health benefits. Packed with fresh fruits, vegetables, whole grains, and lean proteins, these diets promote heart health, weight management, and longevity. By following our meal plans, you can enjoy delicious and nutritious meals that support your overall well-being."
      />
      <DiscoverBenifits />
      <Save srcimg={ndlady} />
      <Faq
